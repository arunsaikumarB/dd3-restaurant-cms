  ...
  return (
    <section className="offers-location-section" aria-labelledby="offers-location-heading">
      <div className="offers-location-section__heading">
        ...
        <p className="offers-location-section__subtitle">
          Select a branch to view exclusive offers available at that restaurant.
        </p>
      </div>
        ...
        {LOCATION_OPTIONS.map((location) => {
          ...
          return (
            ...
            >
              ...
              {active && <span className="offers-location-card__badge">Viewing Offers</span>}
            </button>
          );
        })}
      </div>
