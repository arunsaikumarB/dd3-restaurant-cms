  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <span
          className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full bg-brand-primary px-5 py-3 text-sm font-bold uppercase tracking-wider text-white transition-colors duration-300 group-hover:bg-[#d43415]"
          aria-hidden
        >
          Continue
          <ArrowRight
